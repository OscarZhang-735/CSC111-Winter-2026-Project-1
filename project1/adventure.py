...
class AdventureGame:
    ...
    def __init__(self, game_data_file: str, initial_location_id: int) -> None:
        ...
        self.score = 0
        self.move = 0
        self.targets = ["lucky mug", "usb drive", "laptop charger"]
    ...
    def check_item(self, item_name: str) -> None:
        ...
        if item is not None:
            ...
            if item.name == "locker":
                ...
                if "saw_password_hint" in self.flags:
...
if __name__ == "__main__":
    ...
    while game.ongoing:
        ...
        if not curr_location.visited:
            print(f"LOCATION-{curr_location.id_num}: {curr_location.long_description}")
            curr_location.visited = True
        else:
            print(f"LOCATION-{curr_location.id_num}: {curr_location.brief_description}")
